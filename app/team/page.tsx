        ...
        <div className="w-full">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">Manage your team and track performance</p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
            <Card className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg flex items-center justify-center">
                  <PersonStanding className="w-5 h-5 sm:w-6 sm:h-6 text-primary-foreground" />
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">20</p>
                </div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg flex items-center justify-center">
            ...
            <Card className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm text-gray-600">Hours This Month</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">1,840</p>
                </div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg flex items-center justify-center">
            ...
            <Card className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm text-gray-600">Avg. Utilization</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">87%</p>
                </div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg flex items-center justify-center">
                  <ShipWheel className="w-5 h-5 sm:w-6 sm:h-6 text-primary-foreground rounded" />
                </div>
              </div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {team.map((member) => (
              <Card key={member.id} className="p-4 sm:p-6 hover:shadow-lg transition-shadow">
                <div className="flex flex-col gap-3 sm:gap-4">
                  {/* Header with avatar and basic info */}
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-amber-500 to-amber-600 rounded-md flex items-center justify-center shrink-0">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm font-semibold text-gray-900">€{member.hourlyRate}/hr</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600">Hours This Month</p>
                      <p className="text-xs sm:text-sm font-semibold text-gray-900">{member.hoursThisMonth}h</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600">Active Projects</p>
                      <p className="text-xs sm:text-sm font-semibold text-amber-600">{member.activeProjects}</p>
                    </div>
                    <div>
